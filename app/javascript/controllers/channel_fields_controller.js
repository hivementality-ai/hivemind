...
export default class extends Controller {
  static targets = ["discord", "slack", "telegram", "whatsapp", "signal", "matrix", "email", "imessage", "none"]
  ...
  showFields(type) {
    const platforms = ["discord", "slack", "telegram", "whatsapp", "signal", "matrix", "email", "imessage"]
