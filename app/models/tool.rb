...
class Tool < ApplicationRecord
  ...
  validates :executor_type, presence: true, inclusion: {
    in: %w[shell file_read file_write file_edit web_search web_fetch http_request browser memory_search image cron message heartbeat_write delegate spawn spawn_status sessions_list sessions_send sessions_history session_status agents_list gateway tts gmail drive cloud_storage pdf_read jira email custom_script]
  }
