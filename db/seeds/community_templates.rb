...
# rewritten in Hivemind's voice. Domain knowledge preserved,
# structure and tone are ours.
#
# Source: https://github.com/msitarzewski/agency-agents

puts "Seeding Community Agent Templates..."
...
community_templates.each do |attrs|
  template = AgentTemplate.find_or_initialize_by(name: attrs[:name])
  ...
  template.save!
  puts "  ✓ #{attrs[:name]} [#{attrs[:category]}]"
rescue StandardError => e
  puts "  ✗ #{attrs[:name]}: #{e.message}"
end

puts "Community templates: 143 processed."
